...
//declare function which will return the count of primes in a given range
int countPrimes(int a, int b);

//declare function which will return bool value
bool isTwinPrime(int n);

//declare function which will return the next smallest twin prime integer
int nextTwinPrime(int n);

//declares function which will return the largest twin prime in a given range
...
int main()
{
    ...
    int twinprime = largestTwinPrime(num1, num2);
    cout << "Largest twin prime in range: " << twinprime << endl;
}
